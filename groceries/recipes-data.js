const recipes = [
      {
        ...
        name: "Lemon Butter Chicken Sheet Pan",
        category: "Dinner",
        ...
        ingredients: [
          ...
          { name: "Baby potatoes", quantity: 24, unit: "oz", section: "Produce" },
          { name: "Yellow or white onion", quantity: 1, unit: "", section: "Produce" },
          { name: "Bell pepper", quantity: 1, unit: "", section: "Produce" },
          { name: "Olive oil", quantity: 3, unit: "tbsp", section: "Pantry" },
          { name: "Butter", quantity: 2, unit: "tbsp", section: "Dairy" },
          { name: "Lemon zest", quantity: 0.5, unit: "lemon", section: "Produce" },
          { name: "Lemon juice", quantity: 0.5, unit: "lemon", section: "Produce" },
      ...
      },
      {
        ...
        name: "Sweet Potato Cheeseburger Skillet",
        category: "Dinner",
        source: "Frida Sofia Eats",
        sourceUrl: "https://www.fridasofiaeats.com/recipes/sweet-potato-cheeseburger-skillet",
        servings: 4,
        tags: ["Beef", "Skillet", "Easy", "Dinner"],
        description: "A simple skillet meal with ground beef, sweet potatoes, peppers, and cheddar cheese.",
        ingredients: [
          { name: "Onion", quantity: 1, unit: "", section: "Produce", prep: "diced" },
          { name: "Red bell pepper", quantity: 1, unit: "", section: "Produce", prep: "diced" },
          { name: "Sweet potatoes", quantity: 3, unit: "medium", section: "Produce", prep: "diced" },
          { name: "Olive oil", quantity: "to taste", unit: "", section: "Pantry" },
          { name: "Salt", quantity: "to taste", unit: "", section: "Pantry" },
          { name: "Pepper", quantity: "to taste", unit: "", section: "Pantry" },
          { name: "Ground beef", quantity: 1, unit: "lb", section: "Meat" },
          { name: "Cheddar cheese", quantity: 3, unit: "oz", section: "Dairy", prep: "grated" }
        ]
      },
      {
